...
public class ActivityListUser extends AppCompatActivity {
    ...
    Button btn_register_back, fab_find_alex_gold_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_header.setText("Listado de Clientes");
        ...
        btn_register_back.setOnClickListener(view ->
                {
                    startActivity(new Intent().setClass(ActivityListUser.this, ActivityListCatalog.class));
                    finish();
                }
        );
                        ...
                        for (int x = 0; x < jewls.size(); x++) {
                            ...
                            if (user.getRol().equalsIgnoreCase("cliente")) {
                                if (getIntent().getExtras() != null) {
                                    ...
                                    if (user.getVendor().equalsIgnoreCase(sharedPreferences.getString("phone", "")))
