package cu.entumovil.snb.ui.adapters.admin;
...
public class UserSaleAdminAdapter extends RecyclerView.Adapter<UserViewHolder> implements
    ...
    public UserSaleAdminAdapter(ArrayList<Jewel> aTeam, SwipeRefreshLayout swipeRefreshLayout, Context context) {
    ...
    public void onBindViewHolder(UserViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(
                        handle.getJewl_catalogue().getImage_path()
                )
                .placeholder(R.drawable.splash)
                .error(R.drawable.splash)
                .into(holder.image_jewel);
        holder.name.setText("Cantidad: " + handle.getCount() + "\n\n" +
